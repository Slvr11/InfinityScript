...
namespace InfinityScript
{
    public class GameLog : BaseScript
    {
        ...
        public GameLog()
        {
            ...
            Function.Call(ScriptNames.FunctionList.getdvar, "g_log", "games_mp.log");
            string dvars = (string)Function.GetReturns();
            _fileName = "scripts/" + dvars.Replace("/", "").Replace("\\", "");
        ...
        {
            Write("J;{0};{1};{2}", obj.GetGUID(), obj.EntRef, obj.GetField("name"));
        }

        public override void OnPlayerDisconnect(Entity obj)
        {
            Write("Q;{0};{1};{2}", obj.GetGUID(), obj.EntRef, obj.GetField("name"));
        }
        ...
        public override void OnSay(Entity player, string name, string message)
        {
            ...
            Write("say;{0};{1};{2};{3}", player.GetGUID(), player.EntRef, name, message);
        }
        ...
        private string GetDamageDetails(Entity player)
        {
            ...
            return string.Format("{0};{1};{2};{3}", player.GetGUID(), player.EntRef, player.GetField("sessionteam"), player.Name);
        }
