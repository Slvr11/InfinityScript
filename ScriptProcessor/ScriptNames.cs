...
namespace InfinityScript
{
    static class ScriptNames
    {
        internal enum FunctionList : uint
        {
            ...
            spawnsighttrace = 223,
            precacheturret = 1,
            target_getarray = 2,//getweaponarray?
            setprintchannel = 14,
            print = 15,
            println = 16,
            print3d = 17,
            ...
            //spawnloopsound = 86,
            bullettrace = 88,
            bullettracepassed = 87,//Scr_Error?
            sighttracepassed = 116,
            physicstrace = 118,
            physicstracenormal = 117,
            ...
            createprintchannel = 3, //string/no param, returns int

            //}
            //internal enum TargetedFunction : uint
            //{
            //unknown = 32317, //return entity
            //test = 32330,
            getviewmodel = 33457,
            ...
            target_iprintln = 33343,
            target_iprintlnbold = 33344,
            target_spawn = 33345,
            setentertime = 33346,
            cloneplayer = 33347,
            istalking = 33348,
            ...
            worldpointinreticle_circle = 33270,//Fuck NTA
